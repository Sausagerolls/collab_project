...
(function()
{
	...
	f.prototype.init = function () {
		...
		if (this.g && (this.k = null != e.OVERLAY_DELAY ? e.OVERLAY_DELAY : 5E3, a == Modernizr.audio.mp3)) {
			...
			var c = e.PATH + "CrbUI/audio/button/swf/CrbUI_AP_Overlay.swf";
			...
			swfobject.registerObject("CrbUI_AP_Overlay", "9.0.115", e.PATH + "CrbUI/audio/button/swf/expressInstall.swf");
	...
	function g(b) {
		...
		var d = e.PATH + "CrbUI/audio/button/swf/CrbUI_AP.swf";
		...
		swfobject.registerObject("CrbUI_AP_Flash", "9.0.115", e.PATH + "CrbUI/audio/button/swf/expressInstall.swf");
	...
	function h(b) {
		...
		this.f = e.JQUERY('<img src="' + e.PATH + 'assets/CrbUI/audio/button/img/Play.png" width="' + this.size + '" height="' + this.size + '" style="position:absolute; top:0px; left:0px;" />');
		this.j = 2 * Math.PI;
	...
	function j(b, c) {
		c ? e.JQUERY(b.f).attr("src", e.PATH + "assets/CrbUI/audio/button/img/Pause.png") : e.JQUERY(b.f).attr("src", e.PATH + "assets/CrbUI/audio/button/img/Play.png")
	}
	h.prototype.m = function () {
		e.JQUERY(this.f).attr("src") == e.PATH + "assets/CrbUI/audio/button/img/Play.png" ? CrbUI_AP.play(this) : CrbUI_AP.stop(this)
	};
